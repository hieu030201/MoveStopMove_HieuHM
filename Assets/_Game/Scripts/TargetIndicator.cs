...
public class TargetIndicator : GameUnit
{
    ...
    {
        viewPoint = CMcam.OutputCamera.WorldToViewportPoint(target.position);
        ...
        Vector3 targetSPoint = CMcam.OutputCamera.ViewportToScreenPoint(viewPoint) - screenHalf;
        Vector3 playerSPoint = CMcam.OutputCamera.WorldToScreenPoint(LevelManager.Ins.player.tf.position) - screenHalf;
